    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="<?php echo $nav_base; ?>simulador_investimentos.php" class="nav-link <?php echo $current_page === 'simulador_investimentos.php' ? 'active' : ''; ?>">
                        <span class="nav-icon">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M3 17l4-6 4 4 6-10"/>
                                <circle cx="19" cy="5" r="2"/>
                            </svg>
                        </span>
                        <span class="nav-text">Simulador Invest.</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <ul class="nav-menu">
                <li class="nav-item">
                    <a href="<?php echo $nav_base; ?>definicoes.php" class="nav-link <?php echo $current_page === 'definicoes.php' ? 'active' : ''; ?>">
                        ...
                        <span class="nav-text">Definicões</span>
                    </a>
                </li>
                <?php if ($is_admin): ?>
                <li class="nav-item">
