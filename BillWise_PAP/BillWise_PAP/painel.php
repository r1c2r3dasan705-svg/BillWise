<?php
/* ========================================
   PAINEL PRINCIPAL - BillWise
   Página inicial para utilizadores autenticados.
   Mostra resumo financeiro: KPIs, gráficos, ações rápidas.
   ======================================== */
session_start();
...
try {
    /* ========================================
       CONSULTAS À BASE DE DADOS - Resumo mensal
       ======================================== */
                                    ...
                                    <div class="progress-stats">
                                        <div class="progress-item">
                                            ...
                                            <div class="progress-bar">
                                                <div class="progress-fill <?php echo $percentual_usado > 100 ? 'danger' : ($percentual_usuario > 80 ? 'warning' : 'success'); ?>" 
                    ...
                    <div class="quick-actions-card">
                        ...
                        <div class="actions-list">
                            ...
                            <a href="feedback.php" class="action-button">
                                <span class="action-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" 
   
