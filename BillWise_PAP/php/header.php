<?php
// Componente de cabeÃ§alho - navegaÃ§Ã£o principal e modal de autenticaÃ§Ã£o
...
?>
<a class="skip-link" href="#main">Saltar para o conteÃºdo</a>
<header class="header">
    <div class="container">
        <div class="nav-container">
            ...
            <nav class="nav">
                ...
                <a href="cripto_etfs.php" class="nav-link">Cripto & ETFs</a>
                <?php if ($logged): ?>
                    <!-- Links disponÃ­veis apenas para utilizadores autenticados -->
                    <a href="dashboard.php" class="nav-link">Painel</a>
                    <a href="despesas.php" class="nav-link">Despesas</a>
                    <a href="orcamento.php" class="nav-link">OrÃ§amento</a>
                    <a href="calculadora_ppr.php" class="nav-link">Calculadora</a>
                <?php endif; ?>
            </nav>
            <div class="user-menu">
                <?php if ($logged): ?>
                    <a href="definicoes.php" class="btn btn-outline" style="margin-right:0.5rem;" title="DefiniÃ§Ãµes da Conta">DefiniÃ§Ãµes</a>
                    <span style="margin-right:0.5rem; color:var(--gray-700);">OlÃ¡, <?php echo $user_name; ?></span>
...
<!-- MODAL DE AUTENTICAÃ‡ÃƒO (Login e Registo) -->
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" style="padding:1.5rem;">
            <form id="login-form" style="display:block;">
                ...
                <div class="form-actions"><button class="btn btn-secondary" type="button" id="show-register">Ainda nÃ£o tem conta?</button><button class="btn btn-primary" type="submit">Entrar</button></div>
            </form>
            <form id="register-form" style="display:none;">
                ...
                <div class="form-actions"><button class="btn btn-secondary" type="button" id="show-login">JÃ¡ tenho conta</button><button class="btn btn-primary" type="submit">Registar</button></div>
            </form>
        </div>
    </div>
</div>
    ...
    <div class="modal-content restricted-modal-content">
        ...
        <div class="modal-body">
            <div class="restricted-content">
                ...
                <h3>ConteÃºdo Exclusivo para Membros</h3>
                <p>Para aceder a esta funcionalidade e gerir as suas finanÃ§as, precisa de ter uma conta BillWise.</p>
                <div class="restricted-benefits">
                    <div class="benefit-item">
                        ...
                        <span>GestÃ£o completa de despesas</span>
                    </div>
                    <div class="benefit-item">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 10l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" stroke="#10B981" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <span>OrÃ§amentos personalizados</span>
                    </div>
                    <div class="benefit-item">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 10l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" stroke="#10B981" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
