<?php
// Componente de footer reutilizÃ¡vel
?>
        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-brand">
                    <p>Ferramentas de literacia financeira para vocÃª dominar suas finanÃ§as e alcanÃ§ar seus objetivos.</p>
                </div>
                ...
                <div class="footer-column">
                    ...
                    <?php if (isset($panel_open_login) && $panel_open_login): ?>
                        ...
                        <a href="#" class="open-restricted">OrÃ§amentos</a>
                        <a href="#" class="open-restricted">Simulador PPR</a>
                        <a href="cripto_etfs.php">Cripto & ETFs</a>
                    <?php else: ?>
                        <a href="dashboard.php">Dashboard</a>
                        <a href="despesas.php">Despesas</a>
                        <a href="orcamento.php">OrÃ§amentos</a>
                ...
                <div class="footer-column">
                    <h4>Suporte</h4>
                    <a href="feedback.php">Feedback & ReclamaÃ§Ãµes</a>
                    <a href="#faq">FAQ</a>
        ...
        <div class="container">
            <div class="footer-bottom-content">
                ...
                <div class="footer-badges">
                    ...
                    <span class="badge-footer"><svg class="icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path fill="currentColor" d="M13 2v8h7l-8 12v-8H5z"/></svg> RÃ¡pido</span>
                </div>
            </div>
        </div>
    </div>
